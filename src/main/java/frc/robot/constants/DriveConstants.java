...
public class DriveConstants extends BBConstants {
	...
	public static double driveGearReduction = 1.0 / 7.13;
	public static double steerGearReduction = -1*(8.0 / 24.0 * 14.0 / 72.0);

    public static double steerRatio = 0.4;
    public static double driveRatio = 0.5;

	public static double FLSteerOffset = -5.3274;
	public static double FRSteerOffset = -9.2974;
	public static double BLSteerOffset = -3.9284;
	public static double BRSteerOffset = -2.9329;
